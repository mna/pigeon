...
// on 2015-05-07 12:36:23.357729868 -0400 EDT
...
var ϡtheProgram = &ϡprogram{
	instrs: []ϡinstr{
		{13, -1, []uint16{4, 31}}, {13, -1, []uint16{5}},
		{1, -1, nil}, {0, -1, nil},
		{13, 0, []uint16{4, 117}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 4}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {17, 0, []uint16{1}},
		{16, 0, nil}, {13, 0, []uint16{4, 384}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{1}}, {13, 0, []uint16{3, 1}},
		{13, 0, []uint16{2, 9, 15}}, {18, 0, []uint16{28}},
		{1, 0, nil}, {4, 0, nil},
		{6, 0, []uint16{28}}, {5, 0, []uint16{23}},
		{11, 0, []uint16{2}}, {15, 0, nil},
		{16, 0, nil}, {13, 0, []uint16{1}},
		{13, 0, []uint16{4, 20}}, {1, 0, nil},
		{6, 0, []uint16{37}}, {2, 0, []uint16{0}},
		{16, 0, nil}, {11, 0, []uint16{1}},
		{16, 0, nil}, {13, 2, []uint16{4, 371}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {16, 2, nil},
		{13, 2, []uint16{4, 193}}, {13, 2, []uint16{5}},
		{1, 2, nil}, {11, 2, []uint16{5}},
		{16, 2, nil}, {13, 2, []uint16{4, 44}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {17, 2, []uint16{5}},
		{16, 2, nil}, {13, 2, []uint16{4, 371}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {16, 2, nil},
		{13, 2, []uint16{4, 288}}, {13, 2, []uint16{5}},
		{1, 2, nil}, {11, 2, []uint16{5}},
		{16, 2, nil}, {13, 2, []uint16{4, 371}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {16, 2, nil},
		...
		{13, 2, []uint16{3, 1}}, {13, 2, []uint16{2, 55, 60, 65, 70}},
		{18, 2, []uint16{83}}, {1, 2, nil},
		{4, 2, nil}, {6, 2, []uint16{83}},
		{5, 2, []uint16{78}}, {11, 2, []uint16{2}},
		{15, 2, nil}, {16, 2, nil},
		{13, 2, []uint16{3, 2}}, {13, 2, []uint16{4, 75}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {12, 2, []uint16{94}},
		{4, 2, nil}, {5, 2, []uint16{87}},
		{16, 2, nil}, {13, 2, []uint16{4, 86}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {17, 2, []uint16{7}},
		{16, 2, nil}, {13, 2, []uint16{4, 371}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {16, 2, nil},
		{13, 2, []uint16{1}}, {13, 2, []uint16{3, 1}},
		{13, 2, []uint16{2, 39, 49, 95, 101}}, {18, 2, []uint16{114}},
		{1, 2, nil}, {4, 2, nil},
		{6, 2, []uint16{114}}, {5, 2, []uint16{109}},
		{11, 2, []uint16{2}}, {15, 2, nil},
		{16, 2, nil}, {13, 2, []uint16{1}},
		{13, 2, []uint16{4, 106}}, {1, 2, nil},
		{6, 2, []uint16{123}}, {2, 2, []uint16{1}},
		{16, 2, nil}, {11, 2, []uint16{1}},
		{16, 2, nil}, {13, 6, []uint16{4, 258}},
		{13, 6, []uint16{5}}, {1, 6, nil},
		{11, 6, []uint16{5}}, {16, 6, nil},
		{13, 6, []uint16{4, 125}}, {13, 6, []uint16{5}},
		{1, 6, nil}, {11, 6, []uint16{5}},
		{17, 6, []uint16{5}}, {16, 6, nil},
		{13, 6, []uint16{4, 371}}, {13, 6, []uint16{5}},
		{1, 6, nil}, {11, 6, []uint16{5}},
		{16, 6, nil}, {13, 6, []uint16{4, 315}},
		{13, 6, []uint16{5}}, {1, 6, nil},
		{11, 6, []uint16{5}}, {16, 6, nil},
		{13, 6, []uint16{4, 371}}, {13, 6, []uint16{5}},
		{1, 6, nil}, {11, 6, []uint16{5}},
		{16, 6, nil}, {13, 6, []uint16{4, 258}},
		{13, 6, []uint16{5}}, {1, 6, nil},
		{11, 6, []uint16{5}}, {16, 6, nil},
		{13, 6, []uint16{1}}, {13, 6, []uint16{3, 1}},
		{13, 6, []uint16{2, 136, 141, 146, 151}}, {18, 6, []uint16{164}},
		{1, 6, nil}, {4, 6, nil},
		{6, 6, []uint16{164}}, {5, 6, []uint16{159}},
		{11, 6, []uint16{2}}, {15, 6, nil},
		{16, 6, nil}, {13, 6, []uint16{3, 2}},
		{13, 6, []uint16{4, 156}}, {13, 6, []uint16{5}},
		{1, 6, nil}, {11, 6, []uint16{5}},
		{12, 6, []uint16{175}}, {4, 6, nil},
		{5, 6, []uint16{168}}, {16, 6, nil},
		{13, 6, []uint16{4, 167}}, {13, 6, []uint16{5}},
		{1, 6, nil}, {11, 6, []uint16{5}},
		{17, 6, []uint16{7}}, {16, 6, nil},
		{13, 6, []uint16{1}}, {13, 6, []uint16{3, 1}},
		{13, 6, []uint16{2, 130, 176}}, {18, 6, []uint16{190}},
		{1, 6, nil}, {4, 6, nil},
		{6, 6, []uint16{190}}, {5, 6, []uint16{185}},
		{11, 6, []uint16{2}}, {15, 6, nil},
		{16, 6, nil}, {13, 6, []uint16{1}},
		{13, 6, []uint16{4, 182}}, {1, 6, nil},
		{6, 6, []uint16{199}}, {2, 6, []uint16{2}},
		{16, 6, nil}, {11, 6, []uint16{1}},
		{16, 6, nil}, {13, 9, []uint16{1}},
		{8, 9, []uint16{0}}, {15, 9, nil},
		{16, 9, nil}, {13, 9, []uint16{4, 117}},
		{13, 9, []uint16{5}}, {1, 9, nil},
		{11, 9, []uint16{5}}, {16, 9, nil},
		{13, 9, []uint16{4, 205}}, {13, 9, []uint16{5}},
		{1, 9, nil}, {11, 9, []uint16{5}},
		{17, 9, []uint16{1}}, {16, 9, nil},
		{13, 9, []uint16{1}}, {8, 9, []uint16{1}},
		{15, 9, nil}, {16, 9, nil},
		{13, 9, []uint16{1}}, {13, 9, []uint16{3, 1}},
		{13, 9, []uint16{2, 201, 210, 216}}, {18, 9, []uint16{228}},
		{1, 9, nil}, {4, 9, nil},
		{6, 9, []uint16{228}}, {5, 9, []uint16{223}},
		{11, 9, []uint16{2}}, {15, 9, nil},
		{16, 9, nil}, {13, 9, []uint16{1}},
		{13, 9, []uint16{4, 220}}, {1, 9, nil},
		{6, 9, []uint16{237}}, {2, 9, []uint16{3}},
		{16, 9, nil}, {11, 9, []uint16{1}},
		{16, 9, nil}, {13, 9, []uint16{4, 359}},
		{13, 9, []uint16{5}}, {1, 9, nil},
		{11, 9, []uint16{5}}, {16, 9, nil},
		{13, 9, []uint16{4, 239}}, {13, 9, []uint16{5}},
		{1, 9, nil}, {11, 9, []uint16{5}},
		{17, 9, []uint16{11}}, {16, 9, nil},
		{13, 9, []uint16{1}}, {13, 9, []uint16{4, 244}},
		{1, 9, nil}, {6, 9, []uint16{256}},
		{2, 9, []uint16{4}}, {16, 9, nil},
		{11, 9, []uint16{1}}, {16, 9, nil},
		{13, 9, []uint16{2, 231, 250}}, {18, 9, []uint16{266}},
		{13, 9, []uint16{5}}, {1, 9, nil},
		{11, 9, []uint16{5}}, {7, 9, []uint16{267}},
		{11, 9, []uint16{3}}, {5, 9, []uint16{259}},
		{13, 9, []uint16{3, 1}}, {11, 9, []uint16{2}},
		{16, 9, nil}, {13, 8, []uint16{1}},
		{8, 8, []uint16{2}}, {15, 8, nil},
		{16, 8, nil}, {13, 8, []uint16{1}},
		{8, 8, []uint16{3}}, {15, 8, nil},
		{16, 8, nil}, {13, 8, []uint16{2, 269, 273}},
		{18, 8, []uint16{285}}, {13, 8, []uint16{5}},
		{1, 8, nil}, {11, 8, []uint16{5}},
		{7, 8, []uint16{286}}, {11, 8, []uint16{3}},
		{5, 8, []uint16{278}}, {13, 8, []uint16{3, 1}},
		{11, 8, []uint16{2}}, {16, 8, nil},
		{13, 8, []uint16{1}}, {13, 8, []uint16{4, 277}},
		{1, 8, nil}, {6, 8, []uint16{294}},
		{2, 8, []uint16{5}}, {16, 8, nil},
		{11, 8, []uint16{1}}, {16, 8, nil},
		{13, 10, []uint16{1}}, {8, 10, []uint16{4}},
		{15, 10, nil}, {16, 10, nil},
		{13, 10, []uint16{1}}, {8, 10, []uint16{5}},
		{15, 10, nil}, {16, 10, nil},
		{13, 10, []uint16{2, 296, 300}}, {18, 10, []uint16{312}},
		{13, 10, []uint16{5}}, {1, 10, nil},
		{11, 10, []uint16{5}}, {7, 10, []uint16{313}},
		{11, 10, []uint16{3}}, {5, 10, []uint16{305}},
		{13, 10, []uint16{3, 1}}, {11, 10, []uint16{2}},
		{16, 10, nil}, {13, 10, []uint16{1}},
		{13, 10, []uint16{4, 304}}, {1, 10, nil},
		{6, 10, []uint16{321}}, {2, 10, []uint16{6}},
		{16, 10, nil}, {11, 10, []uint16{1}},
		{16, 10, nil}, {13, 12, []uint16{1}},
		{8, 12, []uint16{3}}, {15, 12, nil},
		{16, 12, nil}, {13, 12, []uint16{4, 323}},
		{13, 12, []uint16{5}}, {1, 12, nil},
		{11, 12, []uint16{5}}, {12, 12, []uint16{333}},
		{16, 12, nil}, {13, 12, []uint16{3, 0}},
		{16, 12, nil}, {13, 12, []uint16{1}},
		{8, 12, []uint16{6}}, {15, 12, nil},
		{16, 12, nil}, {13, 12, []uint16{3, 1}},
		{13, 12, []uint16{4, 335}}, {13, 12, []uint16{5}},
		{1, 12, nil}, {11, 12, []uint16{5}},
		{12, 12, []uint16{347}}, {4, 12, nil},
		{5, 12, []uint16{340}}, {16, 12, nil},
		{13, 12, []uint16{1}}, {13, 12, []uint16{3, 1}},
		{13, 12, []uint16{2, 327, 339}}, {18, 12, []uint16{356}},
		{1, 12, nil}, {4, 12, nil},
		{6, 12, []uint16{356}}, {5, 12, []uint16{351}},
		{11, 12, []uint16{2}}, {15, 12, nil},
		{16, 12, nil}, {13, 12, []uint16{1}},
		{13, 12, []uint16{4, 348}}, {1, 12, nil},
		{6, 12, []uint16{365}}, {2, 12, []uint16{7}},
		{16, 12, nil}, {11, 12, []uint16{1}},
		{16, 12, nil}, {13, 13, []uint16{1}},
		{8, 13, []uint16{7}}, {15, 13, nil},
		{16, 13, nil}, {13, 13, []uint16{3, 2}},
		{13, 13, []uint16{4, 367}}, {13, 13, []uint16{5}},
		{1, 13, nil}, {11, 13, []uint16{5}},
		{12, 13, []uint16{379}}, {4, 13, nil},
		{5, 13, []uint16{372}}, {16, 13, nil},
		{13, 3, []uint16{1}}, {8, 3, []uint16{8}},
		{15, 3, nil}, {16, 3, nil},
		{13, 3, []uint16{1}}, {13, 3, []uint16{4, 380}},
		{13, 3, []uint16{5}}, {1, 3, nil},
		{11, 3, []uint16{5}}, {9, 3, nil},
		{14, 3, nil}, {16, 3, nil},
	},
	ss: []string{
		"Input", "expr", "Expr",
