...
func TestDecodeInstr(t *testing.T) {
	cases := []struct {
		...
		{13<<58 | 2<<48 | 10<<32 | 12345<<16, ϡopPush, []int{10, 12345}},
		{13<<58 | 3<<48 | 1<<32 | 2<<16 | 3, ϡopPush, []int{1, 2, 3}},
	}
...
func TestEncodeInstrValid(t *testing.T) {
	cases := []struct {
		...
		{ϡopPush, []int{1, 2}, []uint64{13<<58 | 2<<48 | 1<<32 | 2<<16}},
		{ϡopPush, []int{1, 2, 3}, []uint64{13<<58 | 3<<48 | 1<<32 | 2<<16 | 3}},
