...
$(TEST_DIR)/staterestore/staterestore.go: $(TEST_DIR)/staterestore/staterestore.peg $(BINDIR)/pigeon
	$(BINDIR)/pigeon $< > $@

$(TEST_DIR)/staterestoreopt/staterestoreopt.go: $(TEST_DIR)/staterestoreopt/staterestoreopt.peg $(BINDIR)/pigeon
