...
pigeon code falls under that guarantee:
    ...
    - The explicitly exported API generated by pigeon. See [5] for the
    documentation of this API on a generated parser.

    - The error type returned by the Parse* functions will always be errList,
    defined as a []error. There are no guarantees on methods of this type,
    other than it implements the error interface.
...
References:
    ...
    [5]: http://godoc.org/github.com/PuerkitoBio/pigeon/test/predicates
