...
// on 2015-05-21 23:12:19.081620571 -0400 EDT
...
var ϡtheProgram = &ϡprogram{
	instrs: []ϡinstr{
		{13, -1, []uint16{4, 19}}, {13, -1, []uint16{5}},
		{1, -1, nil}, {0, -1, nil},
		{13, 0, []uint16{4, 102}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 170}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{4, 220}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{1}},
		{13, 0, []uint16{3, 1}}, {13, 0, []uint16{2, 4, 9, 14}},
		{18, 0, []uint16{27}}, {1, 0, nil},
		{4, 0, nil}, {6, 0, []uint16{27}},
		{5, 0, []uint16{22}}, {11, 0, []uint16{2}},
		{15, 0, nil}, {16, 0, nil},
		{13, 1, []uint16{1}}, {8, 1, []uint16{0}},
		{15, 1, nil}, {16, 1, nil},
		{13, 1, []uint16{4, 30}}, {13, 1, []uint16{5}},
		{1, 1, nil}, {11, 1, []uint16{5}},
		{17, 1, []uint16{4}}, {16, 1, nil},
		{3, 1, []uint16{0}}, {9, 1, nil},
		{16, 1, nil}, {13, 1, []uint16{1}},
		{13, 1, []uint16{3, 1}}, {13, 1, []uint16{2, 34, 40}},
		{18, 1, []uint16{51}}, {1, 1, nil},
		{4, 1, nil}, {6, 1, []uint16{51}},
		{5, 1, []uint16{46}}, {11, 1, []uint16{2}},
		{15, 1, nil}, {16, 1, nil},
		{13, 1, []uint16{1}}, {8, 1, []uint16{1}},
		{15, 1, nil}, {16, 1, nil},
		{13, 1, []uint16{4, 54}}, {13, 1, []uint16{5}},
		{1, 1, nil}, {11, 1, []uint16{5}},
		{17, 1, []uint16{5}}, {16, 1, nil},
		{3, 1, []uint16{1}}, {9, 1, nil},
		{16, 1, nil}, {13, 1, []uint16{1}},
		{13, 1, []uint16{3, 1}}, {13, 1, []uint16{2, 58, 64}},
		{18, 1, []uint16{75}}, {1, 1, nil},
		{4, 1, nil}, {6, 1, []uint16{75}},
		{5, 1, []uint16{70}}, {11, 1, []uint16{2}},
		{15, 1, nil}, {16, 1, nil},
		{13, 1, []uint16{1}}, {8, 1, []uint16{2}},
		{15, 1, nil}, {16, 1, nil},
		{13, 1, []uint16{4, 78}}, {13, 1, []uint16{5}},
		{1, 1, nil}, {11, 1, []uint16{5}},
		{17, 1, []uint16{6}}, {16, 1, nil},
		{3, 1, []uint16{2}}, {10, 1, nil},
		{16, 1, nil}, {13, 1, []uint16{1}},
		{13, 1, []uint16{3, 1}}, {13, 1, []uint16{2, 82, 88}},
		{18, 1, []uint16{99}}, {1, 1, nil},
		{4, 1, nil}, {6, 1, []uint16{99}},
		{5, 1, []uint16{94}}, {11, 1, []uint16{2}},
		{15, 1, nil}, {16, 1, nil},
		{13, 1, []uint16{2, 43, 67, 91}}, {18, 1, []uint16{110}},
		{13, 1, []uint16{5}}, {1, 1, nil},
		{11, 1, []uint16{5}}, {7, 1, []uint16{111}},
		{11, 1, []uint16{3}}, {5, 1, []uint16{103}},
		{13, 1, []uint16{3, 1}}, {11, 1, []uint16{2}},
		{16, 1, nil}, {13, 2, []uint16{1}},
		{8, 2, []uint16{3}}, {15, 2, nil},
		{16, 2, nil}, {13, 2, []uint16{1}},
		{8, 2, []uint16{4}}, {15, 2, nil},
		{16, 2, nil}, {13, 2, []uint16{4, 117}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {17, 2, []uint16{9}},
		{16, 2, nil}, {3, 2, []uint16{3}},
		{10, 2, nil}, {16, 2, nil},
		{13, 2, []uint16{1}}, {13, 2, []uint16{3, 1}},
		{13, 2, []uint16{2, 113, 121, 127}}, {18, 2, []uint16{138}},
		{1, 2, nil}, {4, 2, nil},
		{6, 2, []uint16{138}}, {5, 2, []uint16{133}},
		{11, 2, []uint16{2}}, {15, 2, nil},
		{16, 2, nil}, {13, 2, []uint16{4, 130}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {17, 2, []uint16{8}},
		{16, 2, nil}, {3, 2, []uint16{4}},
		{10, 2, nil}, {16, 2, nil},
		{13, 2, []uint16{1}}, {13, 2, []uint16{3, 1}},
		{13, 2, []uint16{2, 141, 147}}, {18, 2, []uint16{158}},
		{1, 2, nil}, {4, 2, nil},
		{6, 2, []uint16{158}}, {5, 2, []uint16{153}},
		{11, 2, []uint16{2}}, {15, 2, nil},
		{16, 2, nil}, {13, 2, []uint16{4, 150}},
		{13, 2, []uint16{5}}, {1, 2, nil},
		{11, 2, []uint16{5}}, {17, 2, []uint16{7}},
		{16, 2, nil}, {3, 2, []uint16{5}},
		{10, 2, nil}, {16, 2, nil},
		{13, 2, []uint16{1}}, {13, 2, []uint16{3, 1}},
		{13, 2, []uint16{2, 161, 167}}, {18, 2, []uint16{178}},
		{1, 2, nil}, {4, 2, nil},
		{6, 2, []uint16{178}}, {5, 2, []uint16{173}},
		{11, 2, []uint16{2}}, {15, 2, nil},
		{16, 2, nil}, {13, 3, []uint16{1}},
		{8, 3, []uint16{5}}, {15, 3, nil},
		{16, 3, nil}, {13, 3, []uint16{4, 181}},
		{13, 3, []uint16{5}}, {1, 3, nil},
		{11, 3, []uint16{5}}, {17, 3, []uint16{10}},
		{16, 3, nil}, {13, 3, []uint16{1}},
		{13, 3, []uint16{4, 185}}, {13, 3, []uint16{5}},
		{1, 3, nil}, {11, 3, []uint16{5}},
		{10, 3, nil}, {14, 3, nil},
		{16, 3, nil}, {13, 3, []uint16{1}},
		{8, 3, []uint16{6}}, {15, 3, nil},
		{16, 3, nil}, {13, 3, []uint16{4, 199}},
		{13, 3, []uint16{5}}, {1, 3, nil},
		{11, 3, []uint16{5}}, {17, 3, []uint16{11}},
		{16, 3, nil}, {13, 3, []uint16{1}},
		{13, 3, []uint16{3, 1}}, {13, 3, []uint16{2, 191, 203}},
		{18, 3, []uint16{217}}, {1, 3, nil},
		{4, 3, nil}, {6, 3, []uint16{217}},
		{5, 3, []uint16{212}}, {11, 3, []uint16{2}},
		{15, 3, nil}, {16, 3, nil},
		{13, 3, []uint16{1}}, {13, 3, []uint16{4, 209}},
		{1, 3, nil}, {6, 3, []uint16{226}},
		{2, 3, []uint16{0}}, {16, 3, nil},
