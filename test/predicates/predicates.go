...
// on 2015-05-05 21:20:21.375167814 -0400 EDT
...
var ϡtheProgram = &ϡprogram{
	instrs: []ϡinstr{
		{13, -1, []uint16{4, 76}}, {13, -1, []uint16{5}},
		{1, -1, nil}, {0, -1, nil},
		{13, 0, []uint16{1}}, {8, 0, []uint16{0}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{4, 4}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{17, 0, []uint16{1}}, {16, 0, nil},
		{3, 0, []uint16{0}}, {9, 0, nil},
		{16, 0, nil}, {13, 0, []uint16{1}},
		{13, 0, []uint16{3, 1}}, {13, 0, []uint16{2, 8, 14}},
		{18, 0, []uint16{25}}, {1, 0, nil},
		{4, 0, nil}, {6, 0, []uint16{25}},
		{5, 0, []uint16{20}}, {11, 0, []uint16{2}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{1}}, {8, 0, []uint16{1}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{4, 28}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{17, 0, []uint16{2}}, {16, 0, nil},
		{3, 0, []uint16{1}}, {9, 0, nil},
		{16, 0, nil}, {13, 0, []uint16{1}},
		{13, 0, []uint16{3, 1}}, {13, 0, []uint16{2, 32, 38}},
		{18, 0, []uint16{49}}, {1, 0, nil},
		{4, 0, nil}, {6, 0, []uint16{49}},
		{5, 0, []uint16{44}}, {11, 0, []uint16{2}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{1}}, {8, 0, []uint16{2}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{4, 52}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{17, 0, []uint16{3}}, {16, 0, nil},
		{3, 0, []uint16{2}}, {10, 0, nil},
		{16, 0, nil}, {13, 0, []uint16{1}},
		{13, 0, []uint16{3, 1}}, {13, 0, []uint16{2, 56, 62}},
		{18, 0, []uint16{73}}, {1, 0, nil},
		{4, 0, nil}, {6, 0, []uint16{73}},
		{5, 0, []uint16{68}}, {11, 0, []uint16{2}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{2, 17, 41, 65}}, {18, 0, []uint16{84}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {7, 0, []uint16{85}},
		{11, 0, []uint16{3}}, {5, 0, []uint16{77}},
		{13, 0, []uint16{3, 1}}, {11, 0, []uint16{2}},
		{16, 0, nil}, {13, 4, []uint16{1}},
		{8, 4, []uint16{3}}, {15, 4, nil},
		{16, 4, nil}, {13, 4, []uint16{1}},
		{8, 4, []uint16{4}}, {15, 4, nil},
		{16, 4, nil}, {13, 4, []uint16{4, 91}},
		{13, 4, []uint16{5}}, {1, 4, nil},
		{11, 4, []uint16{5}}, {17, 4, []uint16{7}},
		{16, 4, nil}, {3, 4, []uint16{3}},
		{10, 4, nil}, {16, 4, nil},
		{13, 4, []uint16{1}}, {13, 4, []uint16{3, 1}},
		{13, 4, []uint16{2, 87, 95, 101}}, {18, 4, []uint16{112}},
		{1, 4, nil}, {4, 4, nil},
		{6, 4, []uint16{112}}, {5, 4, []uint16{107}},
		{11, 4, []uint16{2}}, {15, 4, nil},
		{16, 4, nil}, {13, 4, []uint16{4, 104}},
		{13, 4, []uint16{5}}, {1, 4, nil},
		{11, 4, []uint16{5}}, {17, 4, []uint16{6}},
		{16, 4, nil}, {3, 4, []uint16{4}},
		{10, 4, nil}, {16, 4, nil},
		{13, 4, []uint16{1}}, {13, 4, []uint16{3, 1}},
		{13, 4, []uint16{2, 115, 121}}, {18, 4, []uint16{132}},
		{1, 4, nil}, {4, 4, nil},
		{6, 4, []uint16{132}}, {5, 4, []uint16{127}},
		{11, 4, []uint16{2}}, {15, 4, nil},
		{16, 4, nil}, {13, 4, []uint16{4, 124}},
		{13, 4, []uint16{5}}, {1, 4, nil},
		{11, 4, []uint16{5}}, {17, 4, []uint16{5}},
		{16, 4, nil}, {3, 4, []uint16{5}},
		{10, 4, nil}, {16, 4, nil},
		{13, 4, []uint16{1}}, {13, 4, []uint16{3, 1}},
		{13, 4, []uint16{2, 135, 141}}, {18, 4, []uint16{152}},
		{1, 4, nil}, {4, 4, nil},
		{6, 4, []uint16{152}}, {5, 4, []uint16{147}},
		{11, 4, []uint16{2}}, {15, 4, nil},
		{16, 4, nil}, {13, 8, []uint16{1}},
		{8, 8, []uint16{5}}, {15, 8, nil},
		{16, 8, nil}, {13, 8, []uint16{4, 155}},
		{13, 8, []uint16{5}}, {1, 8, nil},
		{11, 8, []uint16{5}}, {17, 8, []uint16{9}},
		{16, 8, nil}, {13, 8, []uint16{1}},
		{13, 8, []uint16{4, 159}}, {13, 8, []uint16{5}},
		{1, 8, nil}, {11, 8, []uint16{5}},
		{10, 8, nil}, {14, 8, nil},
		{16, 8, nil}, {13, 8, []uint16{1}},
		{8, 8, []uint16{6}}, {15, 8, nil},
		{16, 8, nil}, {13, 8, []uint16{4, 173}},
		{13, 8, []uint16{5}}, {1, 8, nil},
		{11, 8, []uint16{5}}, {17, 8, []uint16{10}},
		{16, 8, nil}, {13, 8, []uint16{1}},
		{13, 8, []uint16{3, 1}}, {13, 8, []uint16{2, 165, 177}},
		{18, 8, []uint16{191}}, {1, 8, nil},
		{4, 8, nil}, {6, 8, []uint16{191}},
		{5, 8, []uint16{186}}, {11, 8, []uint16{2}},
		{15, 8, nil}, {16, 8, nil},
		{13, 8, []uint16{1}}, {13, 8, []uint16{4, 183}},
		{1, 8, nil}, {6, 8, []uint16{200}},
		{2, 8, []uint16{0}}, {16, 8, nil},
