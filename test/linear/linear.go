...
// on 2015-05-08 12:03:59.692291122 -0400 EDT
...
var ϡtheProgram = &ϡprogram{
	instrs: []ϡinstr{
		{13, -1, []uint16{4, 208}}, {13, -1, []uint16{5}},
		{1, -1, nil}, {0, -1, nil},
		{13, 0, []uint16{4, 223}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 249}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{4, 9}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{12, 0, []uint16{20}}, {16, 0, nil},
		{13, 0, []uint16{3, 0}}, {16, 0, nil},
		{13, 0, []uint16{1}}, {13, 0, []uint16{3, 1}},
		{13, 0, []uint16{2, 4, 14}}, {18, 0, []uint16{30}},
		{1, 0, nil}, {4, 0, nil},
		{6, 0, []uint16{30}}, {5, 0, []uint16{25}},
		{11, 0, []uint16{2}}, {15, 0, nil},
		{16, 0, nil}, {13, 0, []uint16{4, 223}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{4, 236}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 38}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {12, 0, []uint16{49}},
		{16, 0, nil}, {13, 0, []uint16{3, 0}},
		{16, 0, nil}, {13, 0, []uint16{1}},
		{13, 0, []uint16{3, 1}}, {13, 0, []uint16{2, 33, 43}},
		{18, 0, []uint16{59}}, {1, 0, nil},
		{4, 0, nil}, {6, 0, []uint16{59}},
		{5, 0, []uint16{54}}, {11, 0, []uint16{2}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{4, 236}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 223}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{4, 67}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{12, 0, []uint16{78}}, {16, 0, nil},
		{13, 0, []uint16{3, 0}}, {16, 0, nil},
		{13, 0, []uint16{1}}, {13, 0, []uint16{3, 1}},
		{13, 0, []uint16{2, 62, 72}}, {18, 0, []uint16{88}},
		{1, 0, nil}, {4, 0, nil},
		{6, 0, []uint16{88}}, {5, 0, []uint16{83}},
		{11, 0, []uint16{2}}, {15, 0, nil},
		{16, 0, nil}, {13, 0, []uint16{4, 236}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{4, 249}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 96}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {12, 0, []uint16{107}},
		{16, 0, nil}, {13, 0, []uint16{3, 0}},
		{16, 0, nil}, {13, 0, []uint16{1}},
		{13, 0, []uint16{3, 1}}, {13, 0, []uint16{2, 91, 101}},
		{18, 0, []uint16{117}}, {1, 0, nil},
		{4, 0, nil}, {6, 0, []uint16{117}},
		{5, 0, []uint16{112}}, {11, 0, []uint16{2}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{4, 249}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 223}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{4, 125}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{12, 0, []uint16{136}}, {16, 0, nil},
		{13, 0, []uint16{3, 0}}, {16, 0, nil},
		{13, 0, []uint16{1}}, {13, 0, []uint16{3, 1}},
		{13, 0, []uint16{2, 120, 130}}, {18, 0, []uint16{146}},
		{1, 0, nil}, {4, 0, nil},
		{6, 0, []uint16{146}}, {5, 0, []uint16{141}},
		{11, 0, []uint16{2}}, {15, 0, nil},
		{16, 0, nil}, {13, 0, []uint16{4, 249}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{4, 236}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 154}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {12, 0, []uint16{165}},
		{16, 0, nil}, {13, 0, []uint16{3, 0}},
		{16, 0, nil}, {13, 0, []uint16{1}},
		{13, 0, []uint16{3, 1}}, {13, 0, []uint16{2, 149, 159}},
		{18, 0, []uint16{175}}, {1, 0, nil},
		{4, 0, nil}, {6, 0, []uint16{175}},
		{5, 0, []uint16{170}}, {11, 0, []uint16{2}},
		{15, 0, nil}, {16, 0, nil},
		{13, 0, []uint16{2, 22, 51, 80, 109, 138, 167}}, {18, 0, []uint16{186}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {7, 0, []uint16{187}},
		{11, 0, []uint16{3}}, {5, 0, []uint16{179}},
		{13, 0, []uint16{3, 1}}, {11, 0, []uint16{2}},
		{16, 0, nil}, {13, 0, []uint16{4, 208}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{3, 2}}, {13, 0, []uint16{4, 189}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {12, 0, []uint16{202}},
		{4, 0, nil}, {5, 0, []uint16{195}},
		{16, 0, nil}, {13, 0, []uint16{4, 262}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{1}}, {13, 0, []uint16{3, 1}},
		{13, 0, []uint16{2, 178, 194, 203}}, {18, 0, []uint16{216}},
		{1, 0, nil}, {4, 0, nil},
		{6, 0, []uint16{216}}, {5, 0, []uint16{211}},
		{11, 0, []uint16{2}}, {15, 0, nil},
		{16, 0, nil}, {13, 1, []uint16{1}},
		{8, 1, []uint16{0}}, {15, 1, nil},
		{16, 1, nil}, {13, 1, []uint16{3, 1}},
		{13, 1, []uint16{4, 219}}, {13, 1, []uint16{5}},
		{1, 1, nil}, {11, 1, []uint16{5}},
		{12, 1, []uint16{231}}, {4, 1, nil},
		{5, 1, []uint16{224}}, {16, 1, nil},
		{13, 3, []uint16{1}}, {8, 3, []uint16{1}},
		{15, 3, nil}, {16, 3, nil},
		{13, 3, []uint16{3, 1}}, {13, 3, []uint16{4, 232}},
		{13, 3, []uint16{5}}, {1, 3, nil},
		{11, 3, []uint16{5}}, {12, 3, []uint16{244}},
		{4, 3, nil}, {5, 3, []uint16{237}},
		{16, 3, nil}, {13, 2, []uint16{1}},
		{8, 2, []uint16{2}}, {15, 2, nil},
		{16, 2, nil}, {13, 2, []uint16{3, 1}},
		{13, 2, []uint16{4, 245}}, {13, 2, []uint16{5}},
		{1, 2, nil}, {11, 2, []uint16{5}},
		{12, 2, []uint16{257}}, {4, 2, nil},
		{5, 2, []uint16{250}}, {16, 2, nil},
		{13, 4, []uint16{1}}, {8, 4, []uint16{3}},
		{15, 4, nil}, {16, 4, nil},
		{13, 4, []uint16{1}}, {13, 4, []uint16{4, 258}},
		{13, 4, []uint16{5}}, {1, 4, nil},
		{11, 4, []uint16{5}}, {9, 4, nil},
		{14, 4, nil}, {16, 4, nil},
	},
	ss: []string{
		"File", "L", "S",
