...
// on 2015-05-08 12:03:59.606571032 -0400 EDT
...
var ϡtheProgram = &ϡprogram{
	instrs: []ϡinstr{
		{13, -1, []uint16{4, 24}}, {13, -1, []uint16{5}},
		{1, -1, nil}, {0, -1, nil},
		{13, 0, []uint16{4, 121}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 73}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{4, 121}}, {13, 0, []uint16{5}},
		{1, 0, nil}, {11, 0, []uint16{5}},
		{16, 0, nil}, {13, 0, []uint16{4, 134}},
		{13, 0, []uint16{5}}, {1, 0, nil},
		{11, 0, []uint16{5}}, {16, 0, nil},
		{13, 0, []uint16{1}}, {13, 0, []uint16{3, 1}},
		{13, 0, []uint16{2, 4, 9, 14, 19}}, {18, 0, []uint16{32}},
		{1, 0, nil}, {4, 0, nil},
		{6, 0, []uint16{32}}, {5, 0, []uint16{27}},
		{11, 0, []uint16{2}}, {15, 0, nil},
		{16, 0, nil}, {13, 2, []uint16{1}},
		{8, 2, []uint16{0}}, {15, 2, nil},
		{16, 2, nil}, {13, 2, []uint16{3, 1}},
		{13, 2, []uint16{4, 35}}, {13, 2, []uint16{5}},
		{1, 2, nil}, {11, 2, []uint16{5}},
		{12, 2, []uint16{47}}, {4, 2, nil},
		{5, 2, []uint16{40}}, {16, 2, nil},
		{13, 2, []uint16{4, 39}}, {13, 2, []uint16{5}},
		{1, 2, nil}, {11, 2, []uint16{5}},
		{17, 2, []uint16{4}}, {16, 2, nil},
		{3, 2, []uint16{0}}, {10, 2, nil},
		{16, 2, nil}, {13, 2, []uint16{1}},
		{13, 2, []uint16{3, 1}}, {13, 2, []uint16{2, 48, 54}},
		{18, 2, []uint16{65}}, {1, 2, nil},
		{4, 2, nil}, {6, 2, []uint16{65}},
		{5, 2, []uint16{60}}, {11, 2, []uint16{2}},
		{15, 2, nil}, {16, 2, nil},
		{13, 2, []uint16{4, 106}}, {13, 2, []uint16{5}},
		{1, 2, nil}, {11, 2, []uint16{5}},
		{16, 2, nil}, {13, 2, []uint16{2, 57, 68}},
		{18, 2, []uint16{81}}, {13, 2, []uint16{5}},
		{1, 2, nil}, {11, 2, []uint16{5}},
		{7, 2, []uint16{82}}, {11, 2, []uint16{3}},
		{5, 2, []uint16{74}}, {13, 2, []uint16{3, 1}},
		{11, 2, []uint16{2}}, {16, 2, nil},
		{13, 5, []uint16{1}}, {8, 5, []uint16{1}},
		{15, 5, nil}, {16, 5, nil},
		{13, 5, []uint16{3, 1}}, {13, 5, []uint16{4, 84}},
		{13, 5, []uint16{5}}, {1, 5, nil},
		{11, 5, []uint16{5}}, {12, 5, []uint16{96}},
		{4, 5, nil}, {5, 5, []uint16{89}},
		{16, 5, nil}, {13, 5, []uint16{4, 88}},
		{13, 5, []uint16{5}}, {1, 5, nil},
		{11, 5, []uint16{5}}, {17, 5, []uint16{6}},
		{16, 5, nil}, {3, 5, []uint16{1}},
		{9, 5, nil}, {16, 5, nil},
		{13, 5, []uint16{1}}, {13, 5, []uint16{3, 1}},
		{13, 5, []uint16{2, 97, 103}}, {18, 5, []uint16{114}},
		{1, 5, nil}, {4, 5, nil},
		{6, 5, []uint16{114}}, {5, 5, []uint16{109}},
		{11, 5, []uint16{2}}, {15, 5, nil},
		{16, 5, nil}, {13, 1, []uint16{1}},
		{8, 1, []uint16{2}}, {15, 1, nil},
		{16, 1, nil}, {13, 1, []uint16{3, 2}},
		{13, 1, []uint16{4, 117}}, {13, 1, []uint16{5}},
		{1, 1, nil}, {11, 1, []uint16{5}},
		{12, 1, []uint16{129}}, {4, 1, nil},
		{5, 1, []uint16{122}}, {16, 1, nil},
		{13, 3, []uint16{1}}, {8, 3, []uint16{3}},
		{15, 3, nil}, {16, 3, nil},
		{13, 3, []uint16{1}}, {13, 3, []uint16{4, 130}},
